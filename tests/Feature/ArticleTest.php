...
use Illuminate\Foundation\Testing\RefreshDatabase; //se van a ejecutar nuestros seeds

uses(RefreshDatabase::class);

beforeEach(fn () => User::factory()->create()); //usamos nuestro modelo User para tener disponible un usuario ficticio para usar con los test
